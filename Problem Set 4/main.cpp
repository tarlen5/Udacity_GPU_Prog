...
int main(int argc, char **argv) {
  ...
  //////////////////////////// MY ADDITION ///////////////////
  //unsigned* h_outVals = (unsigned*)malloc(numElems*sizeof(unsigned));
  //checkCudaErrors(cudaMemcpy(h_outVals, outputVals, numElems*sizeof(unsigned),
  //                           cudaMemcpyDeviceToHost));
  //FILE* f = fopen("main_outVals.out", "w");
